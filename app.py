...
pg_fifth = st.Page("views/Molaremasserechner.py", title="Molare Massen Rechner", icon=":material/info:")
pg_sixth = st.Page("views/pH_Werte_Rechner.py", title="pH-Rechner", icon=":material/info:")
pg_seventh = st.Page("views/Titer.py", title="Titer-Rechner", icon=":material/info:")
pg_eighth = st.Page("views/Verdünngsrechner.py", title="Verdünngsrechner", icon=":material/info:")

pg = st.navigation([pg_home, pg_second, pg_third, pg_fourth, pg_fifth, pg_sixth, pg_seventh, pg_eighth])
pg.run()
